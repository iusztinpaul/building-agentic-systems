...
from :mod:`tree.memory.graph.add_entity` so the auto-merge surface
...
from tree.memory.graph.add_entity import _apply_merge
...
async def review_duplicate(
    ...
    *,
    ...
    :func:`tree.memory.graph.add_entity._apply_merge` dispatcher,
