...
async def _run(user_id: PydanticObjectId, document_ids: list[str] | None) -> None:
...
def main(user_id: str | None, doc_ids: str | None) -> None:
    ...
    asyncio.run(_run(parsed, parsed_doc_ids))
