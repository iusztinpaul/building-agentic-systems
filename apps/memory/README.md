...
The memory half of Tree (Your Rooted Personal Assistant): ETL data pipelines, a knowledge-graph memory backed by MongoDB, and a FastMCP server that exposes memory tools to agents.
