...
Query, explore, and write to the user's digital twin knowledge graph through the MCP server.

## Instruction

The query or instruction to run is: $ARGUMENTS

If no arguments are provided, ask the user what they want to know or do with their twin memory.
