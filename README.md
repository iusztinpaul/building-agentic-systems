...
- [Modal](https://modal.com/) account + a [Proxy token](https://modal.com/docs/guide/webhook-proxy-auth) — only if you want to serve a model (an embedding model or an LLM) on Modal.
